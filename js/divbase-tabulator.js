  ...
  $(".wb-id-1-tbl").each(function() {
    tables[tables.length] = new Tabulator(this, {
        ...
        columns:[
          ...
          {title:'<i class="fas fa-grip-vertical"></i> Task', field:"task", width:150, editor:"input"},
          {title:'<i class="fas fa-grip-vertical"></i> Location', field:"person", width:130, editor:"autocomplete", editorParams:{allowEmpty:true, showListOnEmpty:true, values:true}},
          {title:'<i class="fas fa-grip-vertical"></i> Progress', field:"progress", rowHandle:false, sorter:"number", hozAlign:"left", formatter:"progress", width:140, editor:true},
          {title:'<i class="fas fa-grip-vertical"></i> Gender', field:"gender", width:130, editor:"select", editorParams:{values:{"male":"Male", "female":"Female", "unknown":"Unknown"}}},
          {title:'<i class="fas fa-grip-vertical"></i> Rating', field:"rating",  formatter:"star", hozAlign:"center", width:100, editor:true},
          {title:'<i class="fas fa-grip-vertical"></i> Deadline', field:"deadline", hozAlign:"center", sorter:"date", width:140, editor:dateEditor},
          {title:'<i class="fas fa-grip-vertical"></i> Tips', field:"tips", width:130, hozAlign:"center", editor:true, formatter:"tickCross"},
        ]
    });
  })
});